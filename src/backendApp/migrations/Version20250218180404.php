 ...
 */
final class Version20250218180404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_instance (id BINARY(16) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, started_at DATETIME DEFAULT NULL, finished_at DATETIME DEFAULT NULL, game_instance_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_instance_action (id BINARY(16) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, game_instance_id BINARY(16) NOT NULL, game_player_id BINARY(16) NOT NULL, INDEX IDX_7B193C0EE404301F (game_instance_id), INDEX IDX_7B193C0E4B4034DD (game_player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_instance_action_affect (id BINARY(16) NOT NULL, game_instance_type VARCHAR(255) NOT NULL, game_instance_action_id BINARY(16) NOT NULL, INDEX IDX_268B5A827B47397E (game_instance_action_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE game_player (id BINARY(16) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, player_id_id BINARY(16) NOT NULL, game_instance_id BINARY(16) NOT NULL, INDEX IDX_E52CD7ADC036E511 (player_id_id), INDEX IDX_E52CD7ADE404301F (game_instance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE player (id BINARY(16) NOT NULL, display_name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, user_id BINARY(16) NOT NULL, UNIQUE INDEX UNIQ_98197A65A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE sudoku_game_instance (id BINARY(16) NOT NULL, solved TINYINT(1) NOT NULL, game_instance_id BINARY(16) NOT NULL, initial_state_id BINARY(16) NOT NULL, UNIQUE INDEX UNIQ_B1206F72E404301F (game_instance_id), INDEX IDX_B1206F72DD616571 (initial_state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE sudoku_grid (id BINARY(16) NOT NULL, grid LONGTEXT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE sudoku_initial_state (id BINARY(16) NOT NULL, hidden_cells LONGTEXT NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, grid_id BINARY(16) NOT NULL, INDEX IDX_F3E0AB782CF16895 (grid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE user (id BINARY(16) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
